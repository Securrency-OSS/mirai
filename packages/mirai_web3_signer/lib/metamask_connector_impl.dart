...
class MetamaskConnector {
  ...
  Future<bool> initialize() async {
    ...
    try {
      ...
      // _web3client = Web3Client(_wcClient.metadata.rp.rpc.first, Client());
  ...
  Future<String?> sendToken(ConnectResponse resp, String walletAddress,
      String topic, String unSignedMessage) async {
    String? signature;
    try {
      // Uri? uri = resp.uri;
      ...
      // final b = DeployedContract(a, EthereumAddress(Uint8List(9)));
      ...
      debugPrint("Catch sendTokenForSigned error $err");
    }
    return signature;
  }
